...
class AdminAuthTest extends TestCase
{
    ...
    public function test_register_with_valid_params()
    {
        ...
        $response->assertStatus(201)
            ->assertJson([
                'msg'           => 'The admin registered successfully',
                'isSuccess'     => true,
                'statusCode'    => 201
            ]);
    }
    ...
    public function test_logout_with_user_authentication()
    {
        ...
        $response = $this->actingAs($user, 'user')->postJson($this->url . '/logout');
        $response->assertStatus(401)->assertJson(['message' => 'Unauthenticated.']);
    }
    ...
    public function test_logout_with_admin_authentication()
    {
        ...
        $response = $this->actingAs($this->admin, 'admin')->postJson($this->url . '/logout');
        $response->assertStatus(202)->assertJson([
